...
android {
  ...
  defaultConfig {
    applicationId = "com.zabi.dev.mindsarrows"
    minSdk = 24
    targetSdk = 36
    versionCode = 3
    versionName = "2.1"
    ...
    buildConfigField("String", "ADMOB_BANNER_AD_ID", "\"ca-app-pub-3940256099942544/6300978111\"")
    ...
    buildConfigField("String", "ADMOB_APP_OPEN_AD_ID", "\"ca-app-pub-3940256099942544/9257395921\"")
  }
